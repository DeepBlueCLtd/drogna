...
export const topology: Topology = {
  ...
  "topics": [
    ...
    },
    {
      ...
      "namespace": "ctl",
      "schema": "contracts/schemas/analysis-published.schema.json",
      "publishers": [
        "analyst"
      ],
      "subscribers": [
      ...
      "named_by": [
        {
          ...
          "path": "app/config/run.json",
          "line": 761,
          "constant": "/analyst/topics/analysis_standing"
        },
        {
          "component": "shell",
          "path": "app/config/run.json",
          "line": 761,
          "constant": "/shell/topics/analysis_standing"
        }
      ]
    },
    {
    ...
    {
      "topic": "ctl/forecast/features",
      "namespace": "ctl",
      "schema": "contracts/schemas/forecast-features.schema.json",
      "publishers": [
        "model-runner"
      ],
      "subscribers": [
      ...
      "named_by": [
        {
          ...
          "path": "app/config/run.json",
          "line": 710,
          "constant": "/model_runner/topics/forecast_features"
        },
        {
          "component": "shell",
          "path": "app/config/run.json",
          "line": 710,
          "constant": "/shell/topics/forecast_features"
        }
      ]
    },
    {
      "topic": "ctl/forecast/indicator",
      "namespace": "ctl",
      "schema": "contracts/schemas/forecast-indicator.schema.json",
      "publishers": [
        "monitor"
      ],
      "subscribers": [
      ...
      "named_by": [
        {
          ...
          "path": "app/config/run.json",
          "line": 656,
          "constant": "/monitor/topics/indicator"
        },
        {
          "component": "shell",
          "path": "app/config/run.json",
          "line": 1448,
          "constant": "/shell/topics/forecast_indicator"
        }
      ]
    },
    {
    ...
    },
    {
      "topic": "ctl/run/cost",
      "namespace": "ctl",
      "schema": "contracts/schemas/run-cost.schema.json",
      "publishers": [
        "model-runner"
      ],
      "subscribers": [
      ...
      "named_by": [
        {
          ...
          "path": "app/config/run.json",
          "line": 687,
          "constant": "/scheduler/topics/run_cost"
        },
        {
          "component": "model-runner",
          "path": "app/config/run.json",
          "line": 687,
          "constant": "/model_runner/topics/run_cost"
        },
        {
          "component": "shell",
          "path": "app/config/run.json",
          "line": 687,
          "constant": "/shell/topics/run_cost"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "named_by": [
        ...
        },
        {
          ...
          "path": "app/config/run.json",
          "line": 683,
          "constant": "/shell/topics/run_request"
        }
      ]
    },
    {
      ...
      "named_by": [
        ...
        },
        {
          ...
          "path": "app/config/run.json",
          "line": 707,
          "constant": "/shell/topics/run_started"
        }
      ]
    },
    {
      ...
      "named_by": [
        ...
        },
        {
          ...
          "path": "app/config/run.json",
          "line": 654,
          "constant": "/model_runner/topics/telemetry"
        },
        {
          "component": "telemetry",
          "path": "app/config/run.json",
