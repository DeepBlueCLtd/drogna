/**
 * The course: the ten explainers in order (FR-002). The order carries the
 ...
 * how consumers hear about it, why the two paths never contend, and the whole thing
 * turning.
 *
 ...
 * stops SC-007 passing vacuously: an eleventh explainer joins the course, becomes
