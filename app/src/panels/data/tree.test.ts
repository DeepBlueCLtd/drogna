/**
 * The tree's shape, held to the master rather than to this file (feature 118).
 *
 * The check that matters is the first one. A branch list typed by hand is the fault
 * feature 118 found on the timeline's lanes — three literals that feature 116's new era
...
describe('the Data tree (feature 118)', () => {
