...
**Status:** Draft for review, written against the endorsed plan (`docs/v2/plan.md`) and
SRD-v2 draft. Adopted only when this text replaces `.specify/memory/constitution.md`
and the reversal ADR moves to Accepted. Until then, 1.6.0 governs.
...
*2.0.0 — the Version 2 reversal (the reversal ADR, numbered at adoption): pure
