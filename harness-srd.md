...
**Status:** Draft v0.6 — scope amended: the EDR composer (§5.13); FR-74 corrected: the plane sits behind the clearance (ADR-0025)
**Author:** Doc
**Date:** 28 August 2026
...
is its own amendment (§5.13). The two records owed under PR-03 are written and
