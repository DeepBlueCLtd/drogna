...
QUERY_LAYER_PATHS: Final[tuple[QueryLayerPath, ...]] = (
    "/",
    "/collections",
    "/collections/forecast",
    "/collections/forecast/cube",
...
QUERY_LAYER_OPERATIONS: Final[Mapping[QueryLayerPath, Mapping[str, str]]] = {
    "/": {"get": "getLandingPage"},
...
__all__ = ["QUERY_LAYER_OPERATIONS", "QUERY_LAYER_PATHS", "QueryLayerPath"]
