"""The monitor connects to the broker its configuration names, and lights a box.
...
from harness_monitor.__main__ import main
...
class _NoForecast:
    """A forecast source with nothing published yet: the monitor still has to say it is alive."""
