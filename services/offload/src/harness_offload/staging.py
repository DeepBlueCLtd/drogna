...
class StagedBundle:
    """One bundle on disk: where its two files are, and what the bundle hashes to."""
...
class StagingArea:
    ...
    def write(self, bundle_id: str, *, payload: bytes, sidecar: bytes, digest: str) -> StagedBundle:
        """Write both files durably, then reveal them: bundle first, sidecar second."""
