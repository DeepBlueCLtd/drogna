"""The planner connects to the broker its configuration names, and lights a box.
...
import planner_support as support
import pytest
...
def _run(
    ...
    *,
    ...
    return main(
        ...
        fields=support.OneField(support.Spread(0.8)),
        timescales=support.Timescales(),
