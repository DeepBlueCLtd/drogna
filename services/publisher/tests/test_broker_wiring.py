"""The publisher connects to the broker its configuration names, and lights a box.
...
from harness_publisher.__main__ import main
...
def _run(
    ...
    *,
    ...
    Path(document["publisher"]["staging"]["directory"]).mkdir(parents=True, exist_ok=True)
    return main(
