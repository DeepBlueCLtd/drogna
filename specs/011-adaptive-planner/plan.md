...
each region will fall below usable confidence. Everything it emits is a
...
│   │                                      time, regrowth per decorrelation timescale
...
and the seeded-feature decorrelation timescales recorded in feature 004's
