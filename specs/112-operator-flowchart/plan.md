...
docs/adr/
├── 0031-ownship-state-is-measured.md    NEW — the enum amendment and why ADR-0005 stands
└── 0032-the-operator-tab-is-a-flow-chart.md  NEW — edges from the topology master;
