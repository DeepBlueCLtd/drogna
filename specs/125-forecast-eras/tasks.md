...
- [ ] **T031** Have the resumed scheduler learn the standing forecast's validity. The
      principled fix for what T030 was aimed at, and it belongs to the model runner: it
      should restate its publication for a late listener as it already restates its cost. The
      snapshot source must not synthesise the announcement.
